...
{
    public class ByNameKeywordSearch : AdvancedSearchDecorator
    {
        public ByNameKeywordSearch() { }

        public ByNameKeywordSearch(AdvancedSearchComponent component) : base(component) { }
        ...
        public override IEnumerable<Product> Search(IEnumerable<Product> products)
        {
            ...
            if (!string.IsNullOrEmpty(Keyword))
                result = products.Where(x => x.Name.ToLower().Contains(Keyword));
